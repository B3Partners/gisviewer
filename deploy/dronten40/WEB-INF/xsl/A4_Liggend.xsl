...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a4-liggend">
                <fo:flow flow-name="body">
                    ...
                    <fo:block-container width="7.6cm" height="2.3cm" top="18.1cm" left="21.8cm" xsl:use-attribute-sets="column-block">
    ...
    <xsl:template name="logo-block">
        <fo:block>
            <fo:external-graphic src="url('logo_dronten.png')" width="181px" height="51px"/>
        </fo:block>
    </xsl:template>
