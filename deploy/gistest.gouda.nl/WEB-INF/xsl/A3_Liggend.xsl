        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a3-liggend">
                <fo:flow flow-name="body">
                    <fo:block-container width="39.5cm" height="1.5cm" top="0cm" left="0cm" background-color="#89A817" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="title-block"/>
                    </fo:block-container>

                    <fo:block-container width="1.5cm" height="1.5cm" top="0cm" left="39.5cm" background-color="#89A817" xsl:use-attribute-sets="column-block">
                        <fo:block />
                    </fo:block-container>
