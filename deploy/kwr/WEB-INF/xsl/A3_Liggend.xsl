        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a3-liggend">
                <fo:flow flow-name="body">                    
                    ...
                    <fo:block-container width="6.6cm" height="4.0cm" top="24.3cm" left="0.75cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="noordpijl-block"/>
                    </fo:block-container>
                    <fo:block-container width="33.0cm" height="2.3cm" top="26.9cm" left="6.7cm" xsl:use-attribute-sets="column-block">
