        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a4-staand">
                <fo:flow flow-name="body">
                    <fo:block-container width="20.4cm" height="1.5cm" top="0cm" left="0cm" background-color="#62BFEA" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="title-block"/>
                    </fo:block-container>

                    <fo:block-container width="6.0cm" height="0.75cm" top="1.6cm" left="0cm" background-color="#114D6F" xsl:use-attribute-sets="column-block">
                    ...
                    <fo:block-container width="12.0cm" height="2.3cm" top="25.5cm" left="0.5cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="disclaimer-block"/>
                    </fo:block-container>

                    <fo:block-container width="7.6cm" height="2.3cm" top="27.0cm" left="7.0cm" xsl:use-attribute-sets="column-block">
