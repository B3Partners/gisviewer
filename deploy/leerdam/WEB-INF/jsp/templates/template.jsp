...
<!--[if gt IE 8]><!--> <html lang="nl"> <!--<![endif]-->
    <head>
        ...
        <link href="<html:rewrite page='/themes/leerdam/styles/gisviewer_base.css' module=''/>" rel="stylesheet" type="text/css">
    ...
    <body class="homebody">
        <script type="text/javascript"> document.body.className = 'homebody ' + 'leerdam' + getRandomInt(1, 5);</script>
        <div id="wrapper">
