...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a3-staand">
                <fo:flow flow-name="body">
                    <fo:block-container width="26.9cm" height="1.5cm" top="0cm" left="0cm" background-color="#db3845" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="title-block"/>
                    </fo:block-container>

                    <fo:block-container width="1.5cm" height="1.5cm" top="0cm" left="26.9cm" background-color="#db3845" xsl:use-attribute-sets="column-block">
                        <fo:block />
                    </fo:block-container>

                    <fo:block-container width="6.6cm" height="0.75cm" top="1.6cm" left="0cm" background-color="#ffc825" xsl:use-attribute-sets="column-block">
                    ...
                    <fo:block-container width="20.8cm" height="2.3cm" top="39.6cm" left="0cm" xsl:use-attribute-sets="column-block">
    ...
    <xsl:template name="title-block">     
        <fo:block>
            <fo:external-graphic src="url('logo_leerdam.png')" content-height="scale-to-fit" content-width="100%" height="1.4cm" scaling="uniform"/>
        </fo:block>   
        <fo:block margin-left="6.8cm" margin-top="-1.2cm" xsl:use-attribute-sets="title-font">
        ...
        <fo:block margin-left="0.2cm" margin-top="0.1cm">
            <xsl:for-each select="legendItems/entry">                
                ...
                <fo:block margin-left="0cm" margin-top="0.05cm" keep-with-previous.within-page="always">
                    <fo:external-graphic src="{$legendUrl}" height="40.0cm" width="100%" content-height="scale-to-fit" content-width="100%" scaling="uniform"/>          
                </fo:block>
            </xsl:for-each>            
        </fo:block>  
    </xsl:template>    
