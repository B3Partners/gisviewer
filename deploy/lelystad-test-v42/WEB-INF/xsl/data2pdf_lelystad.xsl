                ...
                <fo:flow flow-name="body">
                    ...
                    <xsl:if test="count(records) &gt; 0">             
                        ...
                        <xsl:for-each select="/pdfinfo/records/entry">                            
                            <fo:block-container width="28.8cm" height="1.5cm" top="0cm" left="0cm" background-color="#008DBC" xsl:use-attribute-sets="column-block">
                            ...
                            <fo:block-container width="7.6cm" height="2.3cm" top="17.2cm" left="24.0cm" xsl:use-attribute-sets="column-block">
