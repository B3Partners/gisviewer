        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a4-staand">
                <fo:flow flow-name="body">
                    ...
                    <fo:block-container width="6.0cm" height="0.75cm" top="1.6cm" left="0cm" background-color="#008DBC" xsl:use-attribute-sets="column-block">
                    ...
                    <fo:block-container width="7.6cm" height="2.3cm" top="26.5cm" left="16.0cm" xsl:use-attribute-sets="column-block">
