        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a4-liggend">
                <fo:flow flow-name="body">
                    ...
                    <fo:block-container width="20.8cm" height="2.3cm" top="18.2cm" left="0cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="disclaimer-block"/>
                    </fo:block-container>

                    <fo:block-container width="7.6cm" height="2.3cm" top="18.1cm" left="24.0cm" xsl:use-attribute-sets="column-block">
