...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <!-- vars -->
    <xsl:variable name="ratio" select="format-number(info/mapWidth div info/mapHeight,'0.##','MyFormat')" />

    <xsl:variable name="map-width">610</xsl:variable>
    <xsl:variable name="map-height" select="format-number($map-width div $ratio,'####','MyFormat')" />
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a3-staand">
                <fo:flow flow-name="body">
                    ...
                    <fo:block-container width="6.6cm" height="32.6cm" top="2.35cm" left="0cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="info-block"/>
                    </fo:block-container>

                    <fo:block-container width="6.6cm" height="3.7cm" top="35.4cm" left="0cm" xsl:use-attribute-sets="column-block">
                    ...
                    <fo:block-container width="19.0cm" height="2.3cm" top="38.9cm" left="0cm" xsl:use-attribute-sets="column-block">
