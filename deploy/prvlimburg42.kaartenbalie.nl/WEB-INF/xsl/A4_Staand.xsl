            ...
            <fo:page-sequence master-reference="a4-staand">
                <fo:flow flow-name="body">
                    ...
                    <fo:block-container 
                        ...
                        top="{$info-content-top-a4-staand}" 
                        left="{$info-content-left-a4-staand}" 
                    ...
                    <fo:block-container width="12.0cm" height="2.3cm" top="26.1cm" left="0cm" xsl:use-attribute-sets="column-block">
