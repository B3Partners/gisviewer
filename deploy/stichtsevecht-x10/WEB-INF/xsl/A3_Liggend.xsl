...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a3-liggend">
                <fo:flow flow-name="body">
                    <fo:block-container width="39.5cm" height="1.5cm" top="0cm" left="0cm" background-color="#00A5DD" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="title-block"/>
                    </fo:block-container>

                    <fo:block-container width="1.6cm" height="1.5cm" top="0cm" left="39.5cm" background-color="#00A5DD" xsl:use-attribute-sets="column-block">
                        <fo:block />
                    </fo:block-container>

                    <fo:block-container width="6.6cm" height="0.75cm" top="1.6cm" left="0cm" background-color="#004171" xsl:use-attribute-sets="column-block">
                    ...
                    <fo:block-container width="33.0cm" height="2.3cm" top="27.1cm" left="1.0cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="disclaimer-block"/>
                    </fo:block-container>

                    <fo:block-container width="7.6cm" height="2.3cm" top="26.55cm" left="37.55cm" xsl:use-attribute-sets="column-block">
    ...
    <xsl:template name="logo-block">
        <fo:block>
            <fo:external-graphic src="url('sv_print_logo.png')" width="98px" height="84px"/>
        </fo:block>
    </xsl:template>    
</xsl:stylesheet>