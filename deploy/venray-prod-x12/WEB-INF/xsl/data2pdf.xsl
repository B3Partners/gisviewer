...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
                ...
                <fo:flow flow-name="body">
                    ...
                    <xsl:if test="count(records) &gt; 0">             
                        ...
                        <xsl:for-each select="/pdfinfo/records/entry">                            
                            <fo:block-container width="28.8cm" height="1.5cm" top="0cm" left="0cm" background-color="#009900" xsl:use-attribute-sets="column-block">
    ...
    <xsl:template name="logo-block">
        <fo:block margin-top="0.5cm">
            <fo:external-graphic src="url('venray_logo.png')" width="219px" height="50px"/>
        </fo:block>
    </xsl:template>
</xsl:stylesheet>
