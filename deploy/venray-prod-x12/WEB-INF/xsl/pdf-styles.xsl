...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:attribute-set name="color1-column-block" use-attribute-sets="column-block">
        <xsl:attribute name="background-color">#009900</xsl:attribute>
    </xsl:attribute-set>
    ...
    <xsl:variable name="logo-src" select="'venray_logo.png'"/>
    <xsl:variable name="logo-width" select="'219px'"/>
    ...
    <xsl:variable name="logo-left-a4-liggend" select="'23.0cm'"/>    
    <xsl:variable name="logo-top-a4-staand" select="'26.0cm'"/>
    <xsl:variable name="logo-left-a4-staand" select="'14.5cm'"/>
    
    <xsl:variable name="logo-top-a3-liggend" select="'26.8cm'"/>
    <xsl:variable name="logo-left-a3-liggend" select="'35.0cm'"/>  
    <xsl:variable name="logo-top-a3-staand" select="'39.1cm'"/>
    <xsl:variable name="logo-left-a3-staand" select="'23.0cm'"/> 
    ...
    <xsl:variable name="logo-left-a0-liggend" select="'111.8cm'"/>  
