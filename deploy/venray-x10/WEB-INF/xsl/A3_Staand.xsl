...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a3-staand">
                <fo:flow flow-name="body">
                    <fo:block-container width="26.9cm" height="1.5cm" top="0cm" left="0cm" background-color="#009900" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="title-block"/>
                    </fo:block-container>

                    <fo:block-container width="1.52cm" height="1.5cm" top="0cm" left="26.9cm" background-color="#009900" xsl:use-attribute-sets="column-block">
                        <fo:block />
                    </fo:block-container>

                    <fo:block-container width="6.6cm" height="0.75cm" top="1.6cm" left="0cm" background-color="#E5E5E5" xsl:use-attribute-sets="column-block">
                    ...
                    <fo:block-container width="20.8cm" height="2.3cm" top="39.0cm" left="0.5cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="disclaimer-block"/>
                    </fo:block-container>

                    <fo:block-container width="7.6cm" height="2.3cm" top="39.0cm" left="17.95cm" xsl:use-attribute-sets="column-block">
    ...
    <xsl:template name="logo-block">
        <fo:block>
            <fo:external-graphic src="url('venray_logo.gif')" width="295px" height="67px"/>
        </fo:block>
    </xsl:template>    
</xsl:stylesheet>