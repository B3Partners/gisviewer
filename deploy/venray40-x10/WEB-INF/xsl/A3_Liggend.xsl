        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a3-liggend">
                <fo:flow flow-name="body">
                    <fo:block-container width="39.5cm" height="1.5cm" top="0cm" left="0cm" background-color="#009900" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="title-block"/>
                    </fo:block-container>

                    <fo:block-container width="1.58cm" height="1.5cm" top="0cm" left="39.5cm" background-color="#009900" xsl:use-attribute-sets="column-block">
                        <fo:block />
                    </fo:block-container>
                    ...
                    <fo:block-container width="33.0cm" height="2.3cm" top="27.0cm" left="0.5cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="disclaimer-block"/>
                    </fo:block-container>

                    <fo:block-container width="7.6cm" height="2.3cm" top="26.7cm" left="30.5cm" xsl:use-attribute-sets="column-block">
