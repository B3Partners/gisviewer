...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:attribute-set name="color1-column-block" use-attribute-sets="column-block">
        <xsl:attribute name="background-color">#B80000</xsl:attribute>
    </xsl:attribute-set>
    <xsl:attribute-set name="color2-column-block" use-attribute-sets="column-block">
        <xsl:attribute name="background-color">#081B59</xsl:attribute>
    </xsl:attribute-set>
    ...
    <xsl:variable name="logo-src" select="'vlaardingen_logo.png'"/>
