...
public class ImageAction extends PrintAction{
    ...
    static public CombineImageSettings getCombineImageSettingsDigitree(HttpServletRequest request) throws Exception {
        String url = FormUtils.nullIfEmpty(request.getParameter("url"));
