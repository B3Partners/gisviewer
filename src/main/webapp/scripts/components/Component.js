...
B3PGissuite.createComponent = function(className, options, addToInstancesArray) {
    ...
    if(addToInstancesArray || addToInstancesArray === undefined){
...
B3PGissuite.defineComponent = function(className, classDefinition) {
    ...
    if(classDefinition.extend) {
        ...
        B3PGissuite.component[className].prototype = jQuery.extend(B3PGissuite.createComponent(classDefinition.extend), B3PGissuite.component[className].prototype, false);
