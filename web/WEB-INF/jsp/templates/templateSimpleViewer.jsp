    ...
    <head>
        ...
        <c:choose>
            <c:when test="${empty theme}">
                ...
                <link href="<html:rewrite page='/styles/gisviewer_simpleviewer.css' module=''/>" rel="stylesheet" type="text/css">
            </c:when>
            <c:otherwise>
                <%-- Select theme style --%>
                <link href="<html:rewrite page='/themes/${theme}/styles/gisviewer_simpleviewer.css' module=''/>" rel="stylesheet" type="text/css">
            </c:otherwise>
        </c:choose>
