        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a0-liggend">
                <fo:flow flow-name="body">
                    ...
                    <fo:block-container width="6.6cm" height="1.5cm" top="0cm" left="111.7cm" xsl:use-attribute-sets="color1-column-block">
                        <xsl:call-template name="title-block"/>
                    </fo:block-container>
					
                    <fo:block-container width="6.6cm" height="77.2cm" top="1.6cm" left="111.7cm" xsl:use-attribute-sets="column-block">
                    ...
                    <fo:block-container width="6.6cm" height="2.3cm" top="79.0cm" left="111.7cm" xsl:use-attribute-sets="column-block">
