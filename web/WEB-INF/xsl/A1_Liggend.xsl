...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:variable name="map-width-px" select="'2175'"/>
    <xsl:variable name="map-height-px" select="'1540'"/>
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a1-liggend">
                <fo:flow flow-name="body">
                    ...
                    <fo:block-container width="76.7cm" height="54.8cm" top="1.6cm" left="6.7cm" xsl:use-attribute-sets="column-block-border">
                        <xsl:call-template name="map-block"/>
                    </fo:block-container>

                    <fo:block-container width="74.7cm" height="2.3cm" top="56.7cm" left="0cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="disclaimer-block"/>
                    </fo:block-container>

                    <fo:block-container width="7.6cm" height="2.3cm" top="56.7cm" left="74.7cm" xsl:use-attribute-sets="column-block">
    ...
    <xsl:template name="map-block">
            ...
            <fo:block-container height="54.8cm" xsl:use-attribute-sets="column-block">
