...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:variable name="map-width-px" select="'1469'"/>
    <xsl:variable name="map-height-px" select="'2251'"/>
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a1-staand">
                <fo:flow flow-name="body">
                    <fo:block-container width="58.7cm" height="1.5cm" top="0cm" left="0cm" background-color="#008540" xsl:use-attribute-sets="column-block">
                    ...
                    <fo:block-container width="6.6cm" height="80.2cm" top="2.4cm" left="0cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="info-block"/>
                    </fo:block-container>

                    <fo:block-container width="52.0cm" height="79.5cm" top="1.6cm" left="6.7cm" xsl:use-attribute-sets="column-block-border">
                        <xsl:call-template name="map-block"/>
                    </fo:block-container>

                    <fo:block-container width="50.0cm" height="2.3cm" top="81.4cm" left="0cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="disclaimer-block"/>
                    </fo:block-container>

                    <fo:block-container width="7.6cm" height="2.3cm" top="81.4cm" left="50.0cm" xsl:use-attribute-sets="column-block">
    ...
    <xsl:template name="map-block">
            ...
            <fo:block-container height="79.5cm" xsl:use-attribute-sets="column-block">
