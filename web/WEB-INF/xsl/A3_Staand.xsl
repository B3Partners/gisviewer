...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:variable name="map-height-px" select="'1156'"/>
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a3-staand">
                <fo:flow flow-name="body">
                    ...
                    <fo:block-container width="6.6cm" height="36.4cm" top="2.35cm" left="22.5cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="info-block"/>
                    </fo:block-container>

                    <fo:block-container width="22.3cm" height="41.1cm" top="0cm" left="0cm" xsl:use-attribute-sets="column-block-border">
                        <xsl:call-template name="map-block"/>
                    </fo:block-container>

                    <fo:block-container width="6.6cm" height="2.3cm" top="39.0cm" left="22.5cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="disclaimer-block"/>
                    </fo:block-container>

                    <fo:block-container width="6.6cm" height="2.3cm" top="0cm" left="22.5cm" xsl:use-attribute-sets="column-block">
    ...
    <xsl:template name="map-block">
            ...
            <fo:block-container margin-top="0.5cm" height="41.1cm" xsl:use-attribute-sets="column-block">
