...
function exportObjectdata2Report(recordId, commando, gegevensbron) {
    var pdf_export_url = commando; //"services/ReportServlet";

    var pdfFormId = "bronCaption" + gegevensbron.id + "PDFfrm" + recordId;
    var submitForm = $j('<form></form>').attr({
        method: 'post',
        action: pdf_export_url,
        target: 'pdfIframe',
